...
- **Step 0a (1 tool call):** `graphify query "<TICKET-KEY or symbol>" --budget 10000` from `{WORKSPACE_ROOT}`. Use the returned nodes/edges/`source_file` locations to confirm the plan's file list and target your reads with line ranges.
